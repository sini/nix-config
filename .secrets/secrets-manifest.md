...
These secrets must be manually created and encrypted. They are stored in the
repository and rekeyed for each host.
...
These secrets are automatically generated using agenix-rekey's generator
functionality. They will be created automatically if they don't exist.
