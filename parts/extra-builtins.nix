# Original source: https://github.com/oddlama/nix-config/blob/7e32b6d4d9b922892bcbf991902dd88a0c4a8fe7/nix/extra-builtins.nix
#
...
in
{
  ...
  rageImportEncrypted =
    ...
    exec (
      [
        ../scripts/rage-decrypt-and-cache.sh
        nixFile
      ]
      ++ identities
    );
