...
| agenix/axon-03 | nixos | yes (host, secretsConfig) | host:axon-03 |
| axon-03 | nixos | yes (host) | host:axon-03 |
| batteries/define-user/dvicory@axon-03 | nixos | yes (host, user) | host:axon-03 |
| batteries/define-user/pol@axon-03 | nixos | yes (host, user) | host:axon-03 |
| batteries/define-user/sini@axon-03 | nixos | yes (host, user) | host:axon-03 |
| batteries/define-user/theutz@axon-03 | nixos | yes (host, user) | host:axon-03 |
| batteries/define-user/vic@axon-03 | nixos | yes (host, user) | host:axon-03 |
| batteries/hostname/os | nixos | yes (host) | host:axon-03 |
| batteries/inputs'/os | nixos | yes (host) | host:axon-03 |
...
| batteries/self'/os | nixos | yes (host) | host:axon-03 |
| bgp/cilium-bgp | nixos | no | host:axon-03 |
| boot/network-initrd | nixos | no | host:axon-03 |
...
| core/impermanence | nixos | no | host:axon-03 |
...
| core/impermanence/btrfs | nixos | no | host:axon-03 |
...
| core/impermanence/persist-collector | nixos | no | host:axon-03 |
...
| core/impermanence/zfs | nixos | no | host:axon-03 |
...
| core/localization/i18n | nixos | no | host:axon-03 |
...
| core/network/hostsfile | nixos | no | host:axon-03 |
...
| core/network/networking | nixos | no | host:axon-03 |
...
| core/network/tailscale | nixos | no | host:axon-03 |
...
| core/nix/stateVersion | nixos | no | host:axon-03 |
...
| core/perf/disable-docs | nixos | no | host:axon-03 |
...
| core/perf/ssd | nixos | no | host:axon-03 |
...
| core/perf/zram-swap | nixos | no | host:axon-03 |
...
| core/security/openssh | nixos | no | host:axon-03 |
...
| core/security/opkssh | nixos | no | host:axon-03 |
...
| core/security/sudo | nixos | no | host:axon-03 |
...
| core/system/facter | nixos | no | host:axon-03 |
...
| core/system/firmware | nixos | no | host:axon-03 |
...
| core/system/linux-kernel | nixos | no | host:axon-03 |
...
| core/users/deterministic-uids | nixos | no | host:axon-03 |
...
| core/users/home-manager-shared | nixos | no | host:axon-03 |
...
| core/users/shell | nixos | no | host:axon-03 |
...
| gpu/amd | nixos | no | host:axon-03 |
| hardware/thunderbolt-network | nixos | no | host:axon-03 |
| insecure-predicate/os | nixos | yes (host) | host:axon-03 |
| k3s/bootstrap | nixos | no | host:axon-03 |
| k3s/containerd | nixos | no | host:axon-03 |
| k3s/node | nixos | no | host:axon-03 |
| k3s/node-lifecycle | nixos | no | host:axon-03 |
| monitoring/prometheus-exporter | nixos | no | host:axon-03 |
| network/firewall-collector | nixos | no | host:axon-03 |
| networking/thunderbolt-mesh-of | nixos | no | host:axon-03 |
| nix/remote-build-server | nixos | no | host:axon-03 |
...
| secrets/collector | nixos | no | host:axon-03 |
| security/acme | nixos | no | host:axon-03 |
| security/tang | nixos | no | host:axon-03 |
| services/bgp | nixos | no | host:axon-03 |
| services/k3s | nixos | no | host:axon-03 |
| storage/media-data-share | nixos | no | host:axon-03 |
...
- agenix/axon-03
- axon-03
- batteries/define-user/dvicory@axon-03
- batteries/define-user/pol@axon-03
- batteries/define-user/sini@axon-03
- batteries/define-user/theutz@axon-03
- batteries/define-user/vic@axon-03
...
| batteries/define-user/dvicory@axon-03 | nixos | den/batteries |
| batteries/define-user/pol@axon-03 | nixos | den/batteries |
| batteries/define-user/sini@axon-03 | nixos | den/batteries |
| batteries/define-user/theutz@axon-03 | nixos | den/batteries |
| batteries/define-user/vic@axon-03 | nixos | den/batteries |
