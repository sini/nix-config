...
graph LR
  ...
  default_host_axon_03["default"]:::default_host_axon_03_c
  ...
  default_host_axon_03 --> den__batteries__define_user
  default_host_axon_03 --> den__batteries__hostname
  default_host_axon_03 --> den__batteries__inputs_
  default_host_axon_03 --> insecure_predicate
  default_host_axon_03 --> den__batteries__self_
  default_host_axon_03 --> unfree_predicate
  ...
  host --> agenix__axon_03
  host --> axon_03
  host --> core__secrets__collector
  host --> default_host_axon_03
  ...
  classDef default_host_axon_03_c fill:#89b4fa,stroke:#89b4fa,color:#1e1e2e,stroke-width:3px
