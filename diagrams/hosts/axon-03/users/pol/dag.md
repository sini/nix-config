...
graph LR
  ...
  user --> agenix_identity__pol_axon_01
  user --> agenix_identity__pol_axon_02
  user --> agenix_identity__pol_axon_03
  user --> agenix_identity__pol_bitstream
  user --> agenix_identity__pol_uplink
  user --> n_default
  user --> opkssh_authz__pol_axon_01
  user --> opkssh_authz__pol_axon_02
  user --> opkssh_authz__pol_axon_03
  user --> opkssh_authz__pol_bitstream
  user --> opkssh_authz__pol_uplink
  user --> core__network__syncthing__peer
  user --> pol
  user --> core__users__resolved_user_emitter
  user --> user_enrich__pol_axon_01
  user --> user_enrich__pol_axon_02
  user --> user_enrich__pol_axon_03
  user --> user_enrich__pol_bitstream
  user --> user_enrich__pol_uplink
