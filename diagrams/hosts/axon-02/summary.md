...
- **276** aspects across **1** classes (nixos)
- **231** provider sub-aspects
- **58** policies fired
- **6** entity instances
...
| agenix/axon-02                         | nixos   | yes (host, secretsConfig)       | host:axon-02 |
| axon-02                                | nixos   | yes (host)                      | host:axon-02 |
| batteries/define-user/dvicory@axon-02  | nixos   | yes (host, user)                | host:axon-02 |
| batteries/define-user/pol@axon-02      | nixos   | yes (host, user)                | host:axon-02 |
| batteries/define-user/sini@axon-02     | nixos   | yes (host, user)                | host:axon-02 |
| batteries/define-user/theutz@axon-02   | nixos   | yes (host, user)                | host:axon-02 |
| batteries/define-user/vic@axon-02      | nixos   | yes (host, user)                | host:axon-02 |
| batteries/hostname/os                  | nixos   | yes (host)                      | host:axon-02 |
| batteries/inputs'/os                   | nixos   | yes (host)                      | host:axon-02 |
...
| batteries/self'/os                     | nixos   | yes (host)                      | host:axon-02 |
| bgp/cilium-bgp                         | nixos   | no                              | host:axon-02 |
| boot/network-initrd                    | nixos   | no                              | host:axon-02 |
...
| core/impermanence                      | nixos   | no                              | host:axon-02 |
...
| core/impermanence/btrfs                | nixos   | no                              | host:axon-02 |
...
| core/impermanence/persist-collector    | nixos   | no                              | host:axon-02 |
...
| core/impermanence/zfs                  | nixos   | no                              | host:axon-02 |
...
| core/localization/i18n                 | nixos   | no                              | host:axon-02 |
...
| core/network/hostsfile                 | nixos   | no                              | host:axon-02 |
...
| core/network/networking                | nixos   | no                              | host:axon-02 |
...
| core/nix/stateVersion                  | nixos   | no                              | host:axon-02 |
...
| core/perf/disable-docs                 | nixos   | no                              | host:axon-02 |
...
| core/perf/ssd                          | nixos   | no                              | host:axon-02 |
...
| core/perf/zram-swap                    | nixos   | no                              | host:axon-02 |
...
| core/security                          | nixos   | no                              | host:axon-02 |
...
| core/security/openssh                  | nixos   | no                              | host:axon-02 |
...
| core/security/opkssh                   | nixos   | no                              | host:axon-02 |
...
| core/security/sudo                     | nixos   | no                              | host:axon-02 |
...
| core/system/facter                     | nixos   | no                              | host:axon-02 |
...
| core/system/firmware                   | nixos   | no                              | host:axon-02 |
...
| core/system/linux-kernel               | nixos   | no                              | host:axon-02 |
...
| core/systemd                           | nixos   | no                              | host:axon-02 |
...
| core/users/deterministic-uids          | nixos   | no                              | host:axon-02 |
...
| core/users/home-manager-shared         | nixos   | no                              | host:axon-02 |
...
| core/users/shell                       | nixos   | no                              | host:axon-02 |
| core/utils                             | nixos   | no                              | user:dvicory |
| core/utils                             | nixos   | no                              | user:pol     |
| core/utils                             | nixos   | no                              | user:theutz  |
| core/utils                             | nixos   | no                              | user:vic     |
| core/utils                             | nixos   | no                              | host:axon-02 |
| cpu/amd                                | nixos   | no                              | host:axon-02 |
| disk/xfs-disk-longhorn                 | nixos   | no                              | host:axon-02 |
| disk/zfs-diff                          | nixos   | no                              | host:axon-02 |
| disk/zfs-disk-single                   | nixos   | no                              | host:axon-02 |
| gpu/amd                                | nixos   | no                              | host:axon-02 |
| hardware/thunderbolt-network           | nixos   | no                              | host:axon-02 |
| insecure-predicate/os                  | nixos   | yes (host)                      | host:axon-02 |
| k3s/bootstrap                          | nixos   | no                              | host:axon-02 |
| k3s/containerd                         | nixos   | no                              | host:axon-02 |
| k3s/node                               | nixos   | no                              | host:axon-02 |
| k3s/node-lifecycle                     | nixos   | no                              | host:axon-02 |
| monitoring/prometheus-exporter         | nixos   | no                              | host:axon-02 |
| network/firewall-collector             | nixos   | no                              | host:axon-02 |
| networking/thunderbolt-mesh-of         | nixos   | no                              | host:axon-02 |
| nix/remote-build-server                | nixos   | no                              | host:axon-02 |
...
| roles/server                           | nixos   | no                              | host:axon-02 |
| secrets/collector                      | nixos   | no                              | host:axon-02 |
| security/acme                          | nixos   | no                              | host:axon-02 |
| security/tang                          | nixos   | no                              | host:axon-02 |
| services/bgp                           | nixos   | no                              | host:axon-02 |
| services/k3s                           | nixos   | no                              | host:axon-02 |
| storage/media-data-share               | nixos   | no                              | host:axon-02 |
| unfree-predicate/os                    | nixos   | yes (host)                      | host:axon-02 |
...
| zfs-disk-single/root                   | nixos   | no                              | host:axon-02 |

## Classes

### nixos (276)

- agenix-identity/dvicory@axon-01
- agenix-identity/dvicory@axon-02
- agenix-identity/dvicory@axon-03
- agenix-identity/dvicory@bitstream
- agenix-identity/dvicory@uplink
- agenix-identity/pol@axon-01
- agenix-identity/pol@axon-02
- agenix-identity/pol@axon-03
- agenix-identity/pol@bitstream
- agenix-identity/pol@uplink
...
- agenix-identity/theutz@axon-01
- agenix-identity/theutz@axon-02
- agenix-identity/theutz@axon-03
- agenix-identity/theutz@bitstream
- agenix-identity/theutz@uplink
...
- agenix/axon-02
- axon-02
- batteries/define-user/dvicory@axon-02
- batteries/define-user/pol@axon-02
- batteries/define-user/sini@axon-02
- batteries/define-user/theutz@axon-02
- batteries/define-user/vic@axon-02
...
- networking/thunderbolt-mesh-of
- nix/remote-build-server
- opkssh-authz/dvicory@axon-01
- opkssh-authz/dvicory@axon-02
- opkssh-authz/dvicory@axon-03
- opkssh-authz/dvicory@bitstream
- opkssh-authz/dvicory@uplink
- opkssh-authz/pol@axon-01
- opkssh-authz/pol@axon-02
- opkssh-authz/pol@axon-03
- opkssh-authz/pol@bitstream
- opkssh-authz/pol@uplink
...
- opkssh-authz/theutz@axon-01
- opkssh-authz/theutz@axon-02
- opkssh-authz/theutz@axon-03
- opkssh-authz/theutz@bitstream
- opkssh-authz/theutz@uplink
...
- unfree-predicate/os
- user-enrich/dvicory@axon-01
- user-enrich/dvicory@axon-02
- user-enrich/dvicory@axon-03
- user-enrich/dvicory@bitstream
- user-enrich/dvicory@uplink
- user-enrich/pol@axon-01
- user-enrich/pol@axon-02
- user-enrich/pol@axon-03
- user-enrich/pol@bitstream
- user-enrich/pol@uplink
...
- user-enrich/theutz@axon-01
- user-enrich/theutz@axon-02
- user-enrich/theutz@axon-03
- user-enrich/theutz@bitstream
- user-enrich/theutz@uplink
...
| batteries/define-user/dvicory@axon-02    | nixos   | den/batteries          |
| batteries/define-user/pol@axon-02        | nixos   | den/batteries          |
| batteries/define-user/sini@axon-02       | nixos   | den/batteries          |
| batteries/define-user/theutz@axon-02     | nixos   | den/batteries          |
| batteries/define-user/vic@axon-02        | nixos   | den/batteries          |
...
| bgp/cilium-bgp                           | nixos   | services/bgp           |
...
| k3s/bootstrap                            | nixos   | services/k3s           |
| k3s/containerd                           | nixos   | services/k3s           |
| k3s/node                                 | nixos   | services/k3s           |
| k3s/node-lifecycle                       | nixos   | services/k3s           |
...
| networking/thunderbolt-mesh-of           | nixos   | services/networking    |
