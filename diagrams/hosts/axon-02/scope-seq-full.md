# Scope Sequence (expanded): axon-02
...
sequenceDiagram
    ...
    deactivate host
    Note over host: apps/zsh, batteries/define-user, batteries/hostname, batteries/primary-user<br/>bgp/spoke, collect-bgp-peers, collect-host-addrs, collect-k3s-nodes<br/>collect-ollama-endpoints, collect-prometheus-targets, collect-thunderbolt-mesh-peers, collect-vault-peers<br/>core/default, core/deterministic-uids, core/facter, core/firewall-collector<br/>core/firmware, core/home-manager, core/i18n, core/linux-kernel<br/>core/lix, core/nix, core/nix-remote-build-client, core/nixpkgs<br/>core/persist-collector, core/persist-home-collector, core/secrets-collector, core/security<br/>core/shell, core/ssd, core/stateVersion, core/sudo<br/>core/systemd, core/systemd-boot, core/time, core/users<br/>core/utils, default, disk/impermanence, disk/xfs-disk-longhorn<br/>disk/zfs-diff, disk/zfs-disk-single, hardware/cpu-amd, hardware/gpu-amd<br/>hardware/thunderbolt-network, host, insecure-predicate, network/hosts<br/>network/network-boot, network/networking, network/openssh, os-to-host<br/>roles/nix-builder, roles/server, roles/unlock, secrets/agenix<br/>services/acme, services/bgp, services/cilium-bgp, services/k3s<br/>services/k3s-containerd, services/media-data-share, services/nix-remote-build-server, services/prometheus-exporter<br/>services/tailscale, services/tang, services/thunderbolt-mesh-of, unfree-predicate<br/>zfs-disk-single/root
```
