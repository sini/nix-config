...
graph LR
  ...
  user --> agenix_identity__dvicory_axon_01
  user --> agenix_identity__dvicory_axon_02
  user --> agenix_identity__dvicory_axon_03
  user --> agenix_identity__dvicory_bitstream
  user --> agenix_identity__dvicory_uplink
  user --> n_default
  user --> dvicory
  user --> opkssh_authz__dvicory_axon_01
  user --> opkssh_authz__dvicory_axon_02
  user --> opkssh_authz__dvicory_axon_03
  user --> opkssh_authz__dvicory_bitstream
  user --> opkssh_authz__dvicory_uplink
  user --> core__network__syncthing__peer
  user --> core__users__resolved_user_emitter
  user --> user_enrich__dvicory_axon_01
  user --> user_enrich__dvicory_axon_02
  user --> user_enrich__dvicory_axon_03
  user --> user_enrich__dvicory_bitstream
  user --> user_enrich__dvicory_uplink
