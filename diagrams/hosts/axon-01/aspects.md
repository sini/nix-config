...
graph LR
  ...
  axon_01 --> secrets__agenix
  axon_01 --> services__cilium_bgp
  axon_01 --> hardware__cpu_amd
  axon_01 --> core__default
  axon_01 --> hardware__gpu_amd
  axon_01 --> disk__impermanence
  axon_01 --> services__k3s
  axon_01 --> network__network_boot
  axon_01 --> roles__nix_builder
  axon_01 --> roles__server
  axon_01 --> services__bgp__spoke
  axon_01 --> services__thunderbolt_mesh_of
  ...
  classDef axon_01_c fill:#a475f9,stroke:#a475f9,color:#1f2328,stroke-width:3px
...
style ctx_host_axon_01 fill:#d0d7de,stroke:#8c959f,stroke-width:2px
```
