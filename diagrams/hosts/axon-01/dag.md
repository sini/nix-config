...
graph LR
  ...
  subgraph ctx_host_axon_01["host: axon-01"]
  services__security__acme[/"security/acme"\]:::services__security__acme_c
  secrets__agenix_host_axon_01[/"secrets/agenix"\]:::secrets__agenix_host_axon_01_c
  agenix__axon_01{{"agenix/axon-01"}}:::agenix__axon_01_c
  ...
  core__systemd__boot_host_axon_01[/"core/systemd/boot"\]:::core__systemd__boot_host_axon_01_c
  services__k3s__bootstrap[/"k3s/bootstrap"\]:::services__k3s__bootstrap_c
  core__impermanence__btrfs_host_axon_01[/"core/impermanence/btrfs"\]:::core__impermanence__btrfs_host_axon_01_c
  ...
  roles__default_host_axon_01[/"roles/default"\]:::roles__default_host_axon_01_c
  default_host_axon_01["default"]:::default_host_axon_01_c
  den__batteries__define_user[/"batteries/define-user"\]:::den__batteries__define_user_c
  den__batteries__define_user__dvicory_axon_01{{"batteries/define-user/dvicory@axon-01"}}:::den__batteries__define_user__dvicory_axon_01_c
  den__batteries__define_user__pol_axon_01{{"batteries/define-user/pol@axon-01"}}:::den__batteries__define_user__pol_axon_01_c
  den__batteries__define_user__sini_axon_01{{"batteries/define-user/sini@axon-01"}}:::den__batteries__define_user__sini_axon_01_c
  den__batteries__define_user__theutz_axon_01{{"batteries/define-user/theutz@axon-01"}}:::den__batteries__define_user__theutz_axon_01_c
  den__batteries__define_user__vic_axon_01{{"batteries/define-user/vic@axon-01"}}:::den__batteries__define_user__vic_axon_01_c
  core__users__deterministic_uids_host_axon_01[/"core/users/deterministic-uids"\]:::core__users__deterministic_uids_host_axon_01_c
  core__perf__disable_docs_host_axon_01[/"core/perf/disable-docs"\]:::core__perf__disable_docs_host_axon_01_c
  env_users["env-users"]:::env_users_c
  core__system__facter_host_axon_01[/"core/system/facter"\]:::core__system__facter_host_axon_01_c
  core__network__firewall_collector[/"network/firewall-collector"\]:::core__network__firewall_collector_c
  core__system__firmware_host_axon_01[/"core/system/firmware"\]:::core__system__firmware_host_axon_01_c
  core__users__home_manager_shared_host_axon_01[/"core/users/home-manager-shared"\]:::core__users__home_manager_shared_host_axon_01_c
  host["host"]:::host_c
  ...
  core__network__hostsfile_host_axon_01[/"core/network/hostsfile"\]:::core__network__hostsfile_host_axon_01_c
  core__localization__i18n_host_axon_01[/"core/localization/i18n"\]:::core__localization__i18n_host_axon_01_c
  core__impermanence_host_axon_01[/"core/impermanence"\]:::core__impermanence_host_axon_01_c
  ...
  core__system__linux_kernel_host_axon_01[/"core/system/linux-kernel"\]:::core__system__linux_kernel_host_axon_01_c
  services__storage__media_data_share[/"storage/media-data-share"\]:::services__storage__media_data_share_c
  services__storage__media_scratch[/"storage/media-scratch"\]:::services__storage__media_scratch_c
  core__boot__network_initrd[/"boot/network-initrd"\]:::core__boot__network_initrd_c
  core__network__networking_host_axon_01[/"core/network/networking"\]:::core__network__networking_host_axon_01_c
  core__nix_host_axon_01[/"core/nix"\]:::core__nix_host_axon_01_c
  roles__nix_builder[/"roles/nix-builder"\]:::roles__nix_builder_c
  core__nix__nixpkgs_host_axon_01[/"core/nix/nixpkgs"\]:::core__nix__nixpkgs_host_axon_01_c
  ...
  core__security__openssh_host_axon_01[/"core/security/openssh"\]:::core__security__openssh_host_axon_01_c
  core__security__opkssh_host_axon_01[/"core/security/opkssh"\]:::core__security__opkssh_host_axon_01_c
  os_to_host_host_axon_01["os-to-host"]:::os_to_host_host_axon_01_c
  core__impermanence__persist_collector_host_axon_01[/"core/impermanence/persist-collector"\]:::core__impermanence__persist_collector_host_axon_01_c
  core__impermanence__persist_home_collector_host_axon_01[/"core/impermanence/persist-home-collector"\]:::core__impermanence__persist_home_collector_host_axon_01_c
  ...
  core__security_host_axon_01[/"core/security"\]:::core__security_host_axon_01_c
  ...
  core__users__shell_host_axon_01[/"core/users/shell"\]:::core__users__shell_host_axon_01_c
  services__bgp__spoke[/"bgp/spoke"\]:::services__bgp__spoke_c
  core__perf__ssd_host_axon_01[/"core/perf/ssd"\]:::core__perf__ssd_host_axon_01_c
  core__nix__stateVersion_host_axon_01[/"core/nix/stateVersion"\]:::core__nix__stateVersion_host_axon_01_c
  core__security__sudo_host_axon_01[/"core/security/sudo"\]:::core__security__sudo_host_axon_01_c
  core__systemd_host_axon_01[/"core/systemd"\]:::core__systemd_host_axon_01_c
  core__network__tailscale_host_axon_01[/"core/network/tailscale"\]:::core__network__tailscale_host_axon_01_c
  ...
  core__localization__time_host_axon_01[/"core/localization/time"\]:::core__localization__time_host_axon_01_c
  ...
  core__users_host_axon_01[/"core/users"\]:::core__users_host_axon_01_c
  core__utils_host_axon_01[/"core/utils"\]:::core__utils_host_axon_01_c
  disk__xfs_disk_longhorn[/"disk/xfs-disk-longhorn"\]:::disk__xfs_disk_longhorn_c
  core__impermanence__zfs_host_axon_01[/"core/impermanence/zfs"\]:::core__impermanence__zfs_host_axon_01_c
  disk__zfs_diff[/"disk/zfs-diff"\]:::disk__zfs_diff_c
  disk__zfs_disk_single[/"disk/zfs-disk-single"\]:::disk__zfs_disk_single_c
  core__perf__zram_swap_host_axon_01[/"core/perf/zram-swap"\]:::core__perf__zram_swap_host_axon_01_c
  applications__shell__zsh_host_axon_01[/"applications/shell/zsh"\]:::applications__shell__zsh_host_axon_01_c
  axon_01 --> hardware__cpu__amd
  axon_01 --> hardware__gpu__amd
  axon_01 --> services__bgp__cilium_bgp
  axon_01 --> roles__default_host_axon_01
  axon_01 --> services__k3s
  axon_01 --> services__storage__media_scratch
  axon_01 --> core__boot__network_initrd
  axon_01 --> roles__nix_builder
  axon_01 --> roles__server
  axon_01 --> services__bgp__spoke
  axon_01 --> services__networking__thunderbolt_mesh_of
  axon_01 --> roles__unlock
  axon_01 --> disk__xfs_disk_longhorn
  axon_01 --> disk__zfs_disk_single
  core__impermanence_host_axon_01 --> core__impermanence__btrfs_host_axon_01
  core__impermanence_host_axon_01 --> core__impermanence__persist_collector_host_axon_01
  core__impermanence_host_axon_01 --> core__impermanence__persist_home_collector_host_axon_01
  core__impermanence_host_axon_01 --> core__impermanence__zfs_host_axon_01
  default_host_axon_01 --> den__batteries__define_user
  default_host_axon_01 --> den__batteries__hostname
  default_host_axon_01 --> den__batteries__inputs_
  default_host_axon_01 --> insecure_predicate
  default_host_axon_01 --> den__batteries__self_
  default_host_axon_01 --> unfree_predicate
  den__batteries__define_user --> den__batteries__define_user__dvicory_axon_01
  den__batteries__define_user --> den__batteries__define_user__pol_axon_01
  den__batteries__define_user --> den__batteries__define_user__sini_axon_01
  den__batteries__define_user --> den__batteries__define_user__theutz_axon_01
  den__batteries__define_user --> den__batteries__define_user__vic_axon_01
  ...
  host --> agenix__axon_01
  host --> axon_01
  host --> core__secrets__collector
  host --> default_host_axon_01
  ...
  roles__default_host_axon_01 --> secrets__agenix_host_axon_01
  roles__default_host_axon_01 --> core__systemd__boot_host_axon_01
  roles__default_host_axon_01 --> core__users__deterministic_uids_host_axon_01
  roles__default_host_axon_01 --> core__perf__disable_docs_host_axon_01
  roles__default_host_axon_01 --> core__system__facter_host_axon_01
  roles__default_host_axon_01 --> core__system__firmware_host_axon_01
  roles__default_host_axon_01 --> core__users__home_manager_shared_host_axon_01
  roles__default_host_axon_01 --> core__network__hostsfile_host_axon_01
  roles__default_host_axon_01 --> core__localization__i18n_host_axon_01
  roles__default_host_axon_01 --> core__impermanence_host_axon_01
  roles__default_host_axon_01 --> core__system__linux_kernel_host_axon_01
  roles__default_host_axon_01 --> core__network__networking_host_axon_01
  roles__default_host_axon_01 --> core__nix_host_axon_01
  roles__default_host_axon_01 --> core__nix__nixpkgs_host_axon_01
  roles__default_host_axon_01 --> core__security__openssh_host_axon_01
  roles__default_host_axon_01 --> core__security__opkssh_host_axon_01
  roles__default_host_axon_01 --> core__security_host_axon_01
  roles__default_host_axon_01 --> core__users__shell_host_axon_01
  roles__default_host_axon_01 --> core__perf__ssd_host_axon_01
  roles__default_host_axon_01 --> core__nix__stateVersion_host_axon_01
  roles__default_host_axon_01 --> core__security__sudo_host_axon_01
  roles__default_host_axon_01 --> core__systemd_host_axon_01
  roles__default_host_axon_01 --> core__network__tailscale_host_axon_01
  roles__default_host_axon_01 --> core__localization__time_host_axon_01
  roles__default_host_axon_01 --> core__users_host_axon_01
  roles__default_host_axon_01 --> core__utils_host_axon_01
  roles__default_host_axon_01 --> core__perf__zram_swap_host_axon_01
  roles__default_host_axon_01 --> applications__shell__zsh_host_axon_01
  ...
  classDef secrets__agenix_host_axon_01_c fill:#89b4fa,stroke:#89b4fa,color:#1e1e2e,stroke-width:3px
  ...
  classDef agenix__axon_01_c fill:#89b4fa,stroke:#89b4fa,color:#1e1e2e,stroke-width:2px
  ...
  classDef axon_01_c fill:#cba6f7,stroke:#cba6f7,color:#1e1e2e,stroke-width:3px
  ...
  classDef core__systemd__boot_host_axon_01_c fill:#cba6f7,stroke:#cba6f7,color:#1e1e2e,stroke-width:3px
  ...
  classDef core__impermanence__btrfs_host_axon_01_c fill:#89b4fa,stroke:#89b4fa,color:#1e1e2e,stroke-width:3px
  ...
  classDef roles__default_host_axon_01_c fill:#89b4fa,stroke:#89b4fa,color:#1e1e2e,stroke-width:3px
  classDef default_host_axon_01_c fill:#89b4fa,stroke:#89b4fa,color:#1e1e2e,stroke-width:3px
  classDef den__batteries__define_user_c fill:#89b4fa,stroke:#89b4fa,color:#1e1e2e,stroke-width:3px
  classDef den__batteries__define_user__dvicory_axon_01_c fill:#89b4fa,stroke:#89b4fa,color:#1e1e2e,stroke-width:2px
  classDef den__batteries__define_user__pol_axon_01_c fill:#f2cdcd,stroke:#f2cdcd,color:#1e1e2e,stroke-width:2px
  classDef den__batteries__define_user__sini_axon_01_c fill:#f2cdcd,stroke:#f2cdcd,color:#1e1e2e,stroke-width:2px
  classDef den__batteries__define_user__theutz_axon_01_c fill:#cba6f7,stroke:#cba6f7,color:#1e1e2e,stroke-width:2px
  classDef den__batteries__define_user__vic_axon_01_c fill:#f2cdcd,stroke:#f2cdcd,color:#1e1e2e,stroke-width:2px
  ...
  classDef core__users__deterministic_uids_host_axon_01_c fill:#f2cdcd,stroke:#f2cdcd,color:#1e1e2e,stroke-width:3px
  ...
  classDef core__perf__disable_docs_host_axon_01_c fill:#89b4fa,stroke:#89b4fa,color:#1e1e2e,stroke-width:3px
  ...
  classDef core__system__facter_host_axon_01_c fill:#89b4fa,stroke:#89b4fa,color:#1e1e2e,stroke-width:3px
  ...
  classDef core__system__firmware_host_axon_01_c fill:#89b4fa,stroke:#89b4fa,color:#1e1e2e,stroke-width:3px
  ...
  classDef core__users__home_manager_shared_host_axon_01_c fill:#cba6f7,stroke:#cba6f7,color:#1e1e2e,stroke-width:3px
  ...
  classDef core__network__hostsfile_host_axon_01_c fill:#89b4fa,stroke:#89b4fa,color:#1e1e2e,stroke-width:3px
  ...
  classDef core__localization__i18n_host_axon_01_c fill:#cba6f7,stroke:#cba6f7,color:#1e1e2e,stroke-width:3px
  ...
  classDef core__impermanence_host_axon_01_c fill:#cba6f7,stroke:#cba6f7,color:#1e1e2e,stroke-width:3px
  ...
  classDef core__system__linux_kernel_host_axon_01_c fill:#cba6f7,stroke:#cba6f7,color:#1e1e2e,stroke-width:3px
  classDef services__storage__media_data_share_c fill:#cba6f7,stroke:#cba6f7,color:#1e1e2e,stroke-width:3px
  classDef services__storage__media_scratch_c fill:#f2cdcd,stroke:#f2cdcd,color:#1e1e2e,stroke-width:3px
  ...
  classDef core__network__networking_host_axon_01_c fill:#89b4fa,stroke:#89b4fa,color:#1e1e2e,stroke-width:3px
  ...
  classDef core__nix_host_axon_01_c fill:#cba6f7,stroke:#cba6f7,color:#1e1e2e,stroke-width:3px
  ...
  classDef core__nix__nixpkgs_host_axon_01_c fill:#89b4fa,stroke:#89b4fa,color:#1e1e2e,stroke-width:3px
  ...
  classDef core__security__openssh_host_axon_01_c fill:#cba6f7,stroke:#cba6f7,color:#1e1e2e,stroke-width:3px
  ...
  classDef core__security__opkssh_host_axon_01_c fill:#89b4fa,stroke:#89b4fa,color:#1e1e2e,stroke-width:3px
  ...
  classDef os_to_host_host_axon_01_c fill:#f2cdcd,stroke:#f2cdcd,color:#1e1e2e,stroke-width:2px,stroke-dasharray: 8 4
  ...
  classDef core__impermanence__persist_collector_host_axon_01_c fill:#cba6f7,stroke:#cba6f7,color:#1e1e2e,stroke-width:3px
  ...
  classDef core__impermanence__persist_home_collector_host_axon_01_c fill:#f2cdcd,stroke:#f2cdcd,color:#1e1e2e,stroke-width:3px
  ...
  classDef core__security_host_axon_01_c fill:#cba6f7,stroke:#cba6f7,color:#1e1e2e,stroke-width:3px
  ...
  classDef core__users__shell_host_axon_01_c fill:#cba6f7,stroke:#cba6f7,color:#1e1e2e,stroke-width:3px
  ...
  classDef core__perf__ssd_host_axon_01_c fill:#cba6f7,stroke:#cba6f7,color:#1e1e2e,stroke-width:3px
  ...
  classDef core__nix__stateVersion_host_axon_01_c fill:#cba6f7,stroke:#cba6f7,color:#1e1e2e,stroke-width:3px
  ...
  classDef core__security__sudo_host_axon_01_c fill:#89b4fa,stroke:#89b4fa,color:#1e1e2e,stroke-width:3px
  ...
  classDef core__systemd_host_axon_01_c fill:#cba6f7,stroke:#cba6f7,color:#1e1e2e,stroke-width:3px
  ...
  classDef core__network__tailscale_host_axon_01_c fill:#f2cdcd,stroke:#f2cdcd,color:#1e1e2e,stroke-width:3px
  ...
  classDef core__localization__time_host_axon_01_c fill:#f2cdcd,stroke:#f2cdcd,color:#1e1e2e,stroke-width:3px
  ...
  classDef core__users_host_axon_01_c fill:#89b4fa,stroke:#89b4fa,color:#1e1e2e,stroke-width:3px
  ...
  classDef core__utils_host_axon_01_c fill:#f2cdcd,stroke:#f2cdcd,color:#1e1e2e,stroke-width:3px
  ...
  classDef core__impermanence__zfs_host_axon_01_c fill:#89b4fa,stroke:#89b4fa,color:#1e1e2e,stroke-width:3px
  ...
  classDef core__perf__zram_swap_host_axon_01_c fill:#cba6f7,stroke:#cba6f7,color:#1e1e2e,stroke-width:3px
  ...
  classDef applications__shell__zsh_host_axon_01_c fill:#cba6f7,stroke:#cba6f7,color:#1e1e2e,stroke-width:3px
...
style ctx_host_axon_01 fill:#313244,stroke:#6c7086,stroke-width:2px
```
