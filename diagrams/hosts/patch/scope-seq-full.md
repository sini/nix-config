...
sequenceDiagram
    ...
    deactivate host
    Note over host: ai/beads, ai/claude, ai/hunk, ai/llm-agents<br/>ai/rtk, applications/karabiner, applications/raycast, batteries/define-user<br/>batteries/hostname, batteries/inputs', batteries/self', browsers/chromium<br/>browsers/firefox, codium/core, codium/vscode, collect-bgp-peers<br/>collect-container-registries, collect-host-addrs, collect-k3s-nodes, collect-ollama-endpoints<br/>collect-prometheus-targets, collect-thunderbolt-mesh-peers, collect-vault-peers, core/impermanence<br/>core/nix, core/security, core/systemd, core/users<br/>core/utils, default, defaults/appearance, defaults/dock<br/>defaults/finder, defaults/keybindings, defaults/keyboard, defaults/screencapture<br/>defaults/security, defaults/trackpad, editor/nvf, env-users<br/>git/delta, git/github, git/lazygit, git/mergiraf<br/>hardware/adb, host, host-modules-capture, host-to-hm-users<br/>impermanence/btrfs, impermanence/persist-collector, impermanence/persist-home-collector, impermanence/zfs<br/>insecure-predicate, k8s/k9s, lang/c, lang/go<br/>lang/lua, lang/markdown, lang/nix, lang/python<br/>lang/rust, lang/shell, localization/i18n, localization/time<br/>macos/fonts, macos/homebrew, macos/spotlight-apps, mail/protonmail<br/>mcp/codebase-memory, mux/herdr, mux/sesh, mux/tmux<br/>mux/zellij, network/firewall-collector, network/hostsfile, network/networking<br/>network/tailscale, nix/linux-builder, nix/nixpkgs, nix/stateVersion<br/>os-to-host, perf/disable-docs, perf/ssd, perf/zram-swap<br/>productivity/obs-studio, productivity/obsidian, roles/darwin-workstation, roles/default<br/>roles/dev, secrets/agenix, secrets/collector, security/openssh<br/>security/opkssh, security/opkssh-client, security/ssh-agent-mux, security/sudo<br/>shell/archive, shell/bat, shell/bottom, shell/btop<br/>shell/data, shell/direnv, shell/disk, shell/eza<br/>shell/nix-index, shell/process, shell/search, shell/starship<br/>shell/yazi, shell/zoxide, shell/zsh, style/stylix<br/>system/facter, system/firmware, system/linux-kernel, systemd/boot<br/>terminals/alacritty, terminals/kitty, unfree-predicate, users/deterministic-uids<br/>users/home-manager-shared, users/shell, wm/aerospace, wm/jankyborders<br/>wm/sketchybar
