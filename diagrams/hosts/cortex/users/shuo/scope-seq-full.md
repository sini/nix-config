...
sequenceDiagram
    ...
    deactivate user
    Note over user: <policy:hm-user-detect>[0], <policy:user-aspect-auto-include>[2], broadcast-syncthing-hub-shares, broadcast-syncthing-peers<br/>broadcast-syncthing-peers-to-hub, browsers/firefox, core/impermanence, core/nix<br/>core/security, core/systemd, core/users, core/utils<br/>default, expose-resolved-users, gaming/steam, hm-user-detect<br/>homeLinux-to-hm, impermanence/btrfs, impermanence/persist-collector, impermanence/persist-home-collector<br/>impermanence/zfs, localization/i18n, localization/time, media/spicetify<br/>network/hostsfile, network/networking, network/tailscale, nix/nixpkgs<br/>nix/stateVersion, os-to-host, perf/disable-docs, perf/ssd<br/>perf/zram-swap, roles/default, secrets/agenix, security/openssh<br/>security/opkssh, security/sudo, shell/zsh, syncthing/member<br/>syncthing/peer, system/facter, system/firmware, system/linux-kernel<br/>systemd/boot, user, user-aspect-auto-include, user-to-host<br/>users/deterministic-uids, users/home-manager-shared, users/shell
```
