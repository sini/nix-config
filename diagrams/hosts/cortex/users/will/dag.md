...
graph LR
  ...
  user --> agenix_identity__will_blade
  user --> agenix_identity__will_cortex
  user --> n_default
  user --> opkssh_authz__will_blade
  user --> opkssh_authz__will_cortex
  user --> core__network__syncthing__peer
  user --> core__users__resolved_user_emitter
  user --> user_enrich__will_blade
  user --> user_enrich__will_cortex
