...
graph LR
  ...
  default_user_shuo["default"]:::default_user_shuo_c
  ...
  core__users__resolved_user_emitter_user_shuo[/"core/users/resolved-user-emitter"\]:::core__users__resolved_user_emitter_user_shuo_c
  ...
  user_user_shuo["user"]:::user_user_shuo_c
  ...
  user__resolve_user__user_shuo["user/resolve(user)"]:::user__resolve_user__user_shuo_c
  ...
  user_user_shuo --> _policy_hm_user_detect__0__user_shuo
  user_user_shuo --> _policy_user_aspect_auto_include__2_
  user_user_shuo --> agenix_identity__shuo_blade
  user_user_shuo --> agenix_identity__shuo_cortex
  user_user_shuo --> default_user_shuo
  user_user_shuo --> opkssh_authz__shuo_blade
  user_user_shuo --> opkssh_authz__shuo_cortex
  user_user_shuo --> core__network__syncthing__peer_user_shuo
  user_user_shuo --> core__users__resolved_user_emitter_user_shuo
  user_user_shuo --> shuo
  user_user_shuo --> user_enrich__shuo_blade
  user_user_shuo --> user_enrich__shuo_cortex
  user_user_shuo --> user__resolve_user__user_shuo
  end
  ...
  default_user_will["default"]:::default_user_will_c
  ...
  core__users__resolved_user_emitter_user_will[/"core/users/resolved-user-emitter"\]:::core__users__resolved_user_emitter_user_will_c
  ...
  user_user_will["user"]:::user_user_will_c
  ...
  user__resolve_user__user_will["user/resolve(user)"]:::user__resolve_user__user_will_c
  ...
  user_user_will --> _policy_hm_user_detect__0__user_will
  user_user_will --> agenix_identity__will_blade
  user_user_will --> agenix_identity__will_cortex
  user_user_will --> default_user_will
  user_user_will --> opkssh_authz__will_blade
  user_user_will --> opkssh_authz__will_cortex
  user_user_will --> core__network__syncthing__peer_user_will
  user_user_will --> core__users__resolved_user_emitter_user_will
  user_user_will --> user_enrich__will_blade
  user_user_will --> user_enrich__will_cortex
  user_user_will --> user__resolve_user__user_will
  user_user_will --> will
  will --> roles__default_user_will
  end
  subgraph ctx_host_cortex["host: cortex"]
  hardware__adb[/"hardware/adb"\]:::hardware__adb_c
  secrets__agenix_host_cortex[/"secrets/agenix"\]:::secrets__agenix_host_cortex_c
  ...
  default_host_cortex["default"]:::default_host_cortex_c
  ...
  applications__browsers__firefox_host_cortex[/"applications/browsers/firefox"\]:::applications__browsers__firefox_host_cortex_c
  ...
  host__resolve_dev_gui_["host/resolve(dev-gui)"]:::host__resolve_dev_gui__c
  ...
  core__nix__nixpkgs_host_cortex[/"core/nix/nixpkgs"\]:::core__nix__nixpkgs_host_cortex_c
  ...
  os_to_host_host_cortex["os-to-host"]:::os_to_host_host_cortex_c
  ...
  core__impermanence__persist_home_collector_host_cortex[/"core/impermanence/persist-home-collector"\]:::core__impermanence__persist_home_collector_host_cortex_c
  ...
  applications__media__spicetify_host_cortex[/"applications/media/spicetify"\]:::applications__media__spicetify_host_cortex_c
  ...
  core__localization__time_host_cortex[/"core/localization/time"\]:::core__localization__time_host_cortex_c
  ...
  applications__shell__zsh_host_cortex[/"applications/shell/zsh"\]:::applications__shell__zsh_host_cortex_c
  ...
  core__impermanence_host_cortex --> core__impermanence__persist_home_collector_host_cortex
  ...
  default_host_cortex --> den__batteries__define_user
  default_host_cortex --> den__batteries__hostname
  default_host_cortex --> den__batteries__inputs_
  default_host_cortex --> insecure_predicate
  default_host_cortex --> den__batteries__self_
  default_host_cortex --> unfree_predicate
  ...
  roles__default_host_cortex --> secrets__agenix_host_cortex
  ...
  roles__default_host_cortex --> core__nix__nixpkgs_host_cortex
  ...
  roles__default_host_cortex --> core__localization__time_host_cortex
  ...
  roles__default_host_cortex --> applications__shell__zsh_host_cortex
  ...
  roles__dev_gui --> host__resolve_dev_gui_
  ...
  roles__media --> applications__media__spicetify_host_cortex
  ...
  roles__workstation --> applications__browsers__firefox_host_cortex
  ...
  classDef default_user_shuo_c fill:#f2cdcd,stroke:#f2cdcd,color:#1e1e2e,stroke-width:3px
  classDef roles__default_user_will_c fill:#f2cdcd,stroke:#f2cdcd,color:#1e1e2e,stroke-width:3px
  classDef default_user_will_c fill:#f2cdcd,stroke:#f2cdcd,color:#1e1e2e,stroke-width:3px
  classDef roles__default_host_cortex_c fill:#89b4fa,stroke:#89b4fa,color:#1e1e2e,stroke-width:3px
  classDef default_host_cortex_c fill:#89b4fa,stroke:#89b4fa,color:#1e1e2e,stroke-width:3px
  ...
  classDef applications__browsers__firefox_host_cortex_c fill:#cba6f7,stroke:#cba6f7,color:#1e1e2e,stroke-width:3px
  ...
  classDef host__resolve_dev_gui__c fill:#cba6f7,stroke:#cba6f7,color:#1e1e2e,stroke-width:3px
  ...
  classDef os_to_host_host_cortex_c fill:#f2cdcd,stroke:#f2cdcd,color:#1e1e2e,stroke-width:2px,stroke-dasharray: 8 4
  ...
  classDef core__users__resolved_user_emitter_user_shuo_c fill:#f38ba8,stroke:#f38ba8,color:#1e1e2e,stroke-dasharray: 3 3,stroke-width:1px
  classDef core__users__resolved_user_emitter_user_will_c fill:#f38ba8,stroke:#f38ba8,color:#1e1e2e,stroke-dasharray: 3 3,stroke-width:1px
  ...
  classDef applications__media__spicetify_host_cortex_c fill:#cba6f7,stroke:#cba6f7,color:#1e1e2e,stroke-width:3px
  ...
  classDef core__localization__time_host_cortex_c fill:#f2cdcd,stroke:#f2cdcd,color:#1e1e2e,stroke-width:3px
  ...
  classDef user_user_shuo_c fill:#f2cdcd,stroke:#f2cdcd,color:#1e1e2e,stroke-width:3px
  classDef user_user_will_c fill:#f2cdcd,stroke:#f2cdcd,color:#1e1e2e,stroke-width:3px
  ...
  classDef user__resolve_user__user_shuo_c fill:#313244,stroke:#6c7086,color:#cdd6f4,stroke-dasharray: 2 2,stroke-width:1px
  classDef user__resolve_user__user_will_c fill:#313244,stroke:#6c7086,color:#cdd6f4,stroke-dasharray: 2 2,stroke-width:1px
  ...
  classDef applications__shell__zsh_host_cortex_c fill:#cba6f7,stroke:#cba6f7,color:#1e1e2e,stroke-width:3px
