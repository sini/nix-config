...
graph LR
  ...
  user --> agenix_identity__theutz_axon_01
  user --> agenix_identity__theutz_axon_02
  user --> agenix_identity__theutz_axon_03
  user --> agenix_identity__theutz_bitstream
  user --> agenix_identity__theutz_uplink
  user --> n_default
  user --> opkssh_authz__theutz_axon_01
  user --> opkssh_authz__theutz_axon_02
  user --> opkssh_authz__theutz_axon_03
  user --> opkssh_authz__theutz_bitstream
  user --> opkssh_authz__theutz_uplink
  user --> core__network__syncthing__peer
  user --> core__users__resolved_user_emitter
  user --> theutz
  user --> user_enrich__theutz_axon_01
  user --> user_enrich__theutz_axon_02
  user --> user_enrich__theutz_axon_03
  user --> user_enrich__theutz_bitstream
  user --> user_enrich__theutz_uplink
