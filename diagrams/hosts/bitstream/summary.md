...
- **266** aspects across **1** classes (nixos)
- **219** provider sub-aspects
- **58** policies fired
- **6** entity instances
...
| agenix/bitstream                        | nixos   | yes (host, secretsConfig)       | host:bitstream |
| batteries/define-user/dvicory@bitstream | nixos   | yes (host, user)                | host:bitstream |
| batteries/define-user/pol@bitstream     | nixos   | yes (host, user)                | host:bitstream |
| batteries/define-user/sini@bitstream    | nixos   | yes (host, user)                | host:bitstream |
| batteries/define-user/theutz@bitstream  | nixos   | yes (host, user)                | host:bitstream |
| batteries/define-user/vic@bitstream     | nixos   | yes (host, user)                | host:bitstream |
| batteries/hostname/os                   | nixos   | yes (host)                      | host:bitstream |
| batteries/inputs'/os                    | nixos   | yes (host)                      | host:bitstream |
...
| batteries/self'/os                      | nixos   | yes (host)                      | host:bitstream |
| bitstream                               | nixos   | yes (host)                      | host:bitstream |
| boot/network-initrd                     | nixos   | no                              | host:bitstream |
| core/impermanence                       | nixos   | no                              | host:bitstream |
...
| core/impermanence/btrfs                 | nixos   | no                              | host:bitstream |
...
| core/impermanence/persist-collector     | nixos   | no                              | host:bitstream |
...
| core/impermanence/zfs                   | nixos   | no                              | host:bitstream |
...
| core/localization/i18n                  | nixos   | no                              | host:bitstream |
...
| core/network/hostsfile                  | nixos   | no                              | host:bitstream |
...
| core/network/networking                 | nixos   | no                              | host:bitstream |
...
| core/network/tailscale                  | nixos   | no                              | host:bitstream |
...
| core/nix/stateVersion                   | nixos   | no                              | host:bitstream |
...
| core/perf/disable-docs                  | nixos   | no                              | host:bitstream |
...
| core/perf/ssd                           | nixos   | no                              | host:bitstream |
...
| core/perf/zram-swap                     | nixos   | no                              | host:bitstream |
...
| core/security/openssh                   | nixos   | no                              | host:bitstream |
...
| core/security/opkssh                    | nixos   | no                              | host:bitstream |
...
| core/security/sudo                      | nixos   | no                              | host:bitstream |
...
| core/system/facter                      | nixos   | no                              | host:bitstream |
...
| core/system/firmware                    | nixos   | no                              | host:bitstream |
...
| core/system/linux-kernel                | nixos   | no                              | host:bitstream |
...
| core/users/deterministic-uids           | nixos   | no                              | host:bitstream |
...
| core/users/home-manager-shared          | nixos   | no                              | host:bitstream |
...
| core/users/shell                        | nixos   | no                              | host:bitstream |
...
| cpu/amd                                 | nixos   | no                              | host:bitstream |
| disk/zfs-diff                           | nixos   | no                              | host:bitstream |
| disk/zfs-disk-single                    | nixos   | no                              | host:bitstream |
| gpu/amd                                 | nixos   | no                              | host:bitstream |
| insecure-predicate/os                   | nixos   | yes (host)                      | host:bitstream |
| monitoring/prometheus-exporter          | nixos   | no                              | host:bitstream |
| network/firewall-collector              | nixos   | no                              | host:bitstream |
| nix/remote-build-server                 | nixos   | no                              | host:bitstream |
...
| secrets/collector                       | nixos   | no                              | host:bitstream |
| security/acme                           | nixos   | no                              | host:bitstream |
| security/tang                           | nixos   | no                              | host:bitstream |
| storage/media-data-share                | nixos   | no                              | host:bitstream |
...
- agenix/bitstream
- batteries/define-user/dvicory@bitstream
- batteries/define-user/pol@bitstream
- batteries/define-user/sini@bitstream
- batteries/define-user/theutz@bitstream
- batteries/define-user/vic@bitstream
...
| batteries/define-user/dvicory@bitstream  | nixos   | den/batteries          |
| batteries/define-user/pol@bitstream      | nixos   | den/batteries          |
| batteries/define-user/sini@bitstream     | nixos   | den/batteries          |
| batteries/define-user/theutz@bitstream   | nixos   | den/batteries          |
| batteries/define-user/vic@bitstream      | nixos   | den/batteries          |
