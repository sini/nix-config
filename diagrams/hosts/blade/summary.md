...
- **233** aspects across **1** classes (nixos)
- **289** provider sub-aspects
- **51** policies fired
- **5** entity instances
...
| agenix/blade | nixos | yes (host, secretsConfig) | host:blade |
| applications/gaming/steam | nixos | no | host:blade |
| applications/gaming/steam | nixos | no | user:shuo |
| batteries/define-user/shuo@blade | nixos | yes (host, user) | host:blade |
| batteries/define-user/sini@blade | nixos | yes (host, user) | host:blade |
| batteries/define-user/vic@blade | nixos | yes (host, user) | host:blade |
| batteries/define-user/will@blade | nixos | yes (host, user) | host:blade |
| batteries/hostname/os | nixos | yes (host) | host:blade |
| batteries/inputs'/os | nixos | yes (host) | host:blade |
...
| batteries/self'/os | nixos | yes (host) | host:blade |
| blade | nixos | yes (host) | host:blade |
| boot/network-initrd | nixos | no | host:blade |
| boot/wireless-initrd | nixos | no | host:blade |
| core/impermanence | nixos | no | user:vic |
| core/impermanence | nixos | no | host:blade |
| core/impermanence | nixos | no | user:shuo |
| core/impermanence | nixos | no | user:will |
| core/impermanence/btrfs | nixos | no | user:vic |
| core/impermanence/btrfs | nixos | no | host:blade |
...
| core/impermanence/persist-collector | nixos | no | host:blade |
...
| core/network/hostsfile | nixos | no | host:blade |
...
| core/network/networking | nixos | no | host:blade |
...
| core/network/tailscale | nixos | no | host:blade |
...
| core/users/deterministic-uids | nixos | no | host:blade |
...
| core/users/home-manager-shared | nixos | no | host:blade |
...
| core/users/shell | nixos | no | host:blade |
...
| cpu/intel | nixos | no | host:blade |
| desktop/gdm | nixos | no | host:blade |
| desktop/gnome | nixos | no | host:blade |
...
| fonts/nerd-fonts | nixos | no | host:blade |
| fonts/regular | nixos | no | host:blade |
| gaming/emulation | nixos | no | host:blade |
| gaming/nix-ld | nixos | no | host:blade |
| gaming/sunshine | nixos | no | host:blade |
| gpu/intel | nixos | no | host:blade |
| gpu/nvidia | nixos | no | host:blade |
| gpu/nvidia-prime | nixos | no | host:blade |
| hardware/adb | nixos | no | host:blade |
| hardware/audio | nixos | no | host:blade |
| hardware/bluetooth | nixos | no | host:blade |
...
| hardware/laptop | nixos | no | host:blade |
| hardware/performance | nixos | no | host:blade |
| hardware/razer | nixos | no | host:blade |
| host/resolve(dev-gui) | nixos | no | host:blade |
| insecure-predicate/os | nixos | yes (host) | host:blade |
| messaging/kdeconnect | nixos | no | host:blade |
| mux/herdr-pair | nixos | no | host:blade |
| network/firewall-collector | nixos | no | host:blade |
| network/manager | nixos | no | host:blade |
...
| provides/unfree(antigravity) | nixos | yes (class, host) | host:blade |
| provides/unfree(corefonts,vista-fonts) | nixos | yes (class, host) | host:blade |
| secrets/collector | nixos | no | host:blade |
| style/fonts | nixos | no | host:blade |
| style/stylix | nixos | no | host:blade |
...
| virtualization/libvirt | nixos | no | host:blade |
...
- applications/gaming/steam
- batteries/define-user/shuo@blade
- batteries/define-user/sini@blade
- batteries/define-user/vic@blade
- batteries/define-user/will@blade
...
| batteries/define-user/shuo@blade | nixos | den/batteries |
| batteries/define-user/sini@blade | nixos | den/batteries |
| batteries/define-user/vic@blade | nixos | den/batteries |
| batteries/define-user/will@blade | nixos | den/batteries |
...
| boot/wireless-initrd | nixos | core/boot |
...
| gpu/nvidia | nixos | hardware/gpu |
| gpu/nvidia-prime | nixos | hardware/gpu |
...
| hardware/laptop | nixos | hardware |
...
| mux/herdr-pair | nixos | applications/dev/mux |
...
| network/manager | nixos | core/network |
