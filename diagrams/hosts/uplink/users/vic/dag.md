...
graph LR
  ...
  user --> agenix_identity__vic_axon_01
  user --> agenix_identity__vic_axon_02
  user --> agenix_identity__vic_axon_03
  user --> agenix_identity__vic_bitstream
  user --> agenix_identity__vic_blade
  user --> agenix_identity__vic_cortex
  user --> agenix_identity__vic_uplink
  user --> n_default
  user --> opkssh_authz__vic_axon_01
  user --> opkssh_authz__vic_axon_02
  user --> opkssh_authz__vic_axon_03
  user --> opkssh_authz__vic_bitstream
  user --> opkssh_authz__vic_blade
  user --> opkssh_authz__vic_cortex
  user --> opkssh_authz__vic_uplink
  user --> core__network__syncthing__peer
  user --> core__users__resolved_user_emitter
  user --> user_enrich__vic_axon_01
  user --> user_enrich__vic_axon_02
  user --> user_enrich__vic_axon_03
  user --> user_enrich__vic_bitstream
  user --> user_enrich__vic_blade
  user --> user_enrich__vic_cortex
  user --> user_enrich__vic_uplink
