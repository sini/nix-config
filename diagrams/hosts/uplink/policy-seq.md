...
sequenceDiagram
    participant root as uplink
    participant broadcast_hub_peer as broadcast-hub-peer
    ...
    root ->> broadcast_hub_peer: dispatch
    activate broadcast_hub_peer
    deactivate broadcast_hub_peer
