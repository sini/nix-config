...
- **285** aspects across **1** classes (nixos)
- **241** provider sub-aspects
- **59** policies fired
- **6** entity instances
...
- ai/ollama
- ai/open-webui
- batteries/define-user/dvicory@uplink
- batteries/define-user/pol@uplink
- batteries/define-user/sini@uplink
- batteries/define-user/theutz@uplink
- batteries/define-user/vic@uplink
