...
graph LR
  ...
  secrets__agenix_host_uplink[/"secrets/agenix"\]:::secrets__agenix_host_uplink_c
  agenix__uplink{{"agenix/uplink"}}:::agenix__uplink_c
  hardware__cpu__amd[/"cpu/amd"\]:::hardware__cpu__amd_c
  services__nix__attic[/"nix/attic"\]:::services__nix__attic_c
  services__bgp[/"services/bgp"\]:::services__bgp_c
  core__systemd__boot_host_uplink[/"core/systemd/boot"\]:::core__systemd__boot_host_uplink_c
  broadcast_hub_peer["broadcast-hub-peer"]:::broadcast_hub_peer_c
  core__impermanence__btrfs_host_uplink[/"core/impermanence/btrfs"\]:::core__impermanence__btrfs_host_uplink_c
  ...
  services__web__container_registry[/"web/container-registry"\]:::services__web__container_registry_c
  virtualization__containers[/"virtualization/containers"\]:::virtualization__containers_c
  roles__default_host_uplink[/"roles/default"\]:::roles__default_host_uplink_c
  default_host_uplink["default"]:::default_host_uplink_c
  den__batteries__define_user[/"batteries/define-user"\]:::den__batteries__define_user_c
  den__batteries__define_user__dvicory_uplink{{"batteries/define-user/dvicory@uplink"}}:::den__batteries__define_user__dvicory_uplink_c
  den__batteries__define_user__pol_uplink{{"batteries/define-user/pol@uplink"}}:::den__batteries__define_user__pol_uplink_c
  den__batteries__define_user__sini_uplink{{"batteries/define-user/sini@uplink"}}:::den__batteries__define_user__sini_uplink_c
  den__batteries__define_user__theutz_uplink{{"batteries/define-user/theutz@uplink"}}:::den__batteries__define_user__theutz_uplink_c
  den__batteries__define_user__vic_uplink{{"batteries/define-user/vic@uplink"}}:::den__batteries__define_user__vic_uplink_c
  services__web__den_docs_mirror[/"web/den-docs-mirror"\]:::services__web__den_docs_mirror_c
  core__users__deterministic_uids_host_uplink[/"core/users/deterministic-uids"\]:::core__users__deterministic_uids_host_uplink_c
  core__perf__disable_docs_host_uplink[/"core/perf/disable-docs"\]:::core__perf__disable_docs_host_uplink_c
  env_users["env-users"]:::env_users_c
  core__system__facter_host_uplink[/"core/system/facter"\]:::core__system__facter_host_uplink_c
  core__network__firewall_collector[/"network/firewall-collector"\]:::core__network__firewall_collector_c
  core__system__firmware_host_uplink[/"core/system/firmware"\]:::core__system__firmware_host_uplink_c
  services__monitoring__grafana[/"monitoring/grafana"\]:::services__monitoring__grafana_c
  services__networking__haproxy[/"networking/haproxy"\]:::services__networking__haproxy_c
  services__networking__headscale[/"networking/headscale"\]:::services__networking__headscale_c
  core__users__home_manager_shared_host_uplink[/"core/users/home-manager-shared"\]:::core__users__home_manager_shared_host_uplink_c
  services__web__homepage[/"web/homepage"\]:::services__web__homepage_c
  host["host"]:::host_c
  ...
  core__network__hostsfile_host_uplink[/"core/network/hostsfile"\]:::core__network__hostsfile_host_uplink_c
  services__bgp__hub[/"bgp/hub"\]:::services__bgp__hub_c
  core__network__syncthing__hub[/"syncthing/hub"\]:::core__network__syncthing__hub_c
  core__localization__i18n_host_uplink[/"core/localization/i18n"\]:::core__localization__i18n_host_uplink_c
  core__impermanence_host_uplink[/"core/impermanence"\]:::core__impermanence_host_uplink_c
  ...
  services__media__jellyfin[/"media/jellyfin"\]:::services__media__jellyfin_c
  services__security__kanidm[/"security/kanidm"\]:::services__security__kanidm_c
  core__system__linux_kernel_host_uplink[/"core/system/linux-kernel"\]:::core__system__linux_kernel_host_uplink_c
  services__monitoring__loki[/"monitoring/loki"\]:::services__monitoring__loki_c
  ...
  core__network__networking_host_uplink[/"core/network/networking"\]:::core__network__networking_host_uplink_c
  services__networking__nginx[/"networking/nginx"\]:::services__networking__nginx_c
  core__nix_host_uplink[/"core/nix"\]:::core__nix_host_uplink_c
  roles__nix_builder[/"roles/nix-builder"\]:::roles__nix_builder_c
  core__nix__nixpkgs_host_uplink[/"core/nix/nixpkgs"\]:::core__nix__nixpkgs_host_uplink_c
  services__security__oauth2_proxy[/"security/oauth2-proxy"\]:::services__security__oauth2_proxy_c
  services__ai__ollama[/"ai/ollama"\]:::services__ai__ollama_c
  services__ai__open_webui[/"ai/open-webui"\]:::services__ai__open_webui_c
  core__security__openssh_host_uplink[/"core/security/openssh"\]:::core__security__openssh_host_uplink_c
  core__security__opkssh_host_uplink[/"core/security/opkssh"\]:::core__security__opkssh_host_uplink_c
  os_to_host_host_uplink["os-to-host"]:::os_to_host_host_uplink_c
  core__impermanence__persist_collector_host_uplink[/"core/impermanence/persist-collector"\]:::core__impermanence__persist_collector_host_uplink_c
  core__impermanence__persist_home_collector_host_uplink[/"core/impermanence/persist-home-collector"\]:::core__impermanence__persist_home_collector_host_uplink_c
  virtualization__podman[/"virtualization/podman"\]:::virtualization__podman_c
  services__monitoring__prometheus[/"monitoring/prometheus"\]:::services__monitoring__prometheus_c
  ...
  core__security_host_uplink[/"core/security"\]:::core__security_host_uplink_c
  ...
  core__users__shell_host_uplink[/"core/users/shell"\]:::core__users__shell_host_uplink_c
  core__perf__ssd_host_uplink[/"core/perf/ssd"\]:::core__perf__ssd_host_uplink_c
  core__nix__stateVersion_host_uplink[/"core/nix/stateVersion"\]:::core__nix__stateVersion_host_uplink_c
  core__security__sudo_host_uplink[/"core/security/sudo"\]:::core__security__sudo_host_uplink_c
  core__systemd_host_uplink[/"core/systemd"\]:::core__systemd_host_uplink_c
  core__network__tailscale_host_uplink[/"core/network/tailscale"\]:::core__network__tailscale_host_uplink_c
  services__security__tang[/"security/tang"\]:::services__security__tang_c
  core__localization__time_host_uplink[/"core/localization/time"\]:::core__localization__time_host_uplink_c
  ...
  core__users_host_uplink[/"core/users"\]:::core__users_host_uplink_c
  core__utils_host_uplink[/"core/utils"\]:::core__utils_host_uplink_c
  core__impermanence__zfs_host_uplink[/"core/impermanence/zfs"\]:::core__impermanence__zfs_host_uplink_c
  disk__zfs_diff[/"disk/zfs-diff"\]:::disk__zfs_diff_c
  disk__zfs_disk_single[/"disk/zfs-disk-single"\]:::disk__zfs_disk_single_c
  core__perf__zram_swap_host_uplink[/"core/perf/zram-swap"\]:::core__perf__zram_swap_host_uplink_c
  applications__shell__zsh_host_uplink[/"applications/shell/zsh"\]:::applications__shell__zsh_host_uplink_c
  core__impermanence_host_uplink --> core__impermanence__btrfs_host_uplink
  core__impermanence_host_uplink --> core__impermanence__persist_collector_host_uplink
  core__impermanence_host_uplink --> core__impermanence__persist_home_collector_host_uplink
  core__impermanence_host_uplink --> core__impermanence__zfs_host_uplink
  default_host_uplink --> den__batteries__define_user
  default_host_uplink --> den__batteries__hostname
  default_host_uplink --> den__batteries__inputs_
  default_host_uplink --> insecure_predicate
  default_host_uplink --> den__batteries__self_
  default_host_uplink --> unfree_predicate
  den__batteries__define_user --> den__batteries__define_user__dvicory_uplink
  den__batteries__define_user --> den__batteries__define_user__pol_uplink
  den__batteries__define_user --> den__batteries__define_user__sini_uplink
  den__batteries__define_user --> den__batteries__define_user__theutz_uplink
  den__batteries__define_user --> den__batteries__define_user__vic_uplink
  ...
  roles__default_host_uplink --> secrets__agenix_host_uplink
  roles__default_host_uplink --> core__systemd__boot_host_uplink
  roles__default_host_uplink --> core__users__deterministic_uids_host_uplink
  roles__default_host_uplink --> core__perf__disable_docs_host_uplink
  roles__default_host_uplink --> core__system__facter_host_uplink
  roles__default_host_uplink --> core__system__firmware_host_uplink
  roles__default_host_uplink --> core__users__home_manager_shared_host_uplink
  roles__default_host_uplink --> core__network__hostsfile_host_uplink
  roles__default_host_uplink --> core__localization__i18n_host_uplink
  roles__default_host_uplink --> core__impermanence_host_uplink
  roles__default_host_uplink --> core__system__linux_kernel_host_uplink
  roles__default_host_uplink --> core__network__networking_host_uplink
  roles__default_host_uplink --> core__nix_host_uplink
  roles__default_host_uplink --> core__nix__nixpkgs_host_uplink
  roles__default_host_uplink --> core__security__openssh_host_uplink
  roles__default_host_uplink --> core__security__opkssh_host_uplink
  roles__default_host_uplink --> core__security_host_uplink
  roles__default_host_uplink --> core__users__shell_host_uplink
  roles__default_host_uplink --> core__perf__ssd_host_uplink
  roles__default_host_uplink --> core__nix__stateVersion_host_uplink
  roles__default_host_uplink --> core__security__sudo_host_uplink
  roles__default_host_uplink --> core__systemd_host_uplink
  roles__default_host_uplink --> core__network__tailscale_host_uplink
  roles__default_host_uplink --> core__localization__time_host_uplink
  roles__default_host_uplink --> core__users_host_uplink
  roles__default_host_uplink --> core__utils_host_uplink
  roles__default_host_uplink --> core__perf__zram_swap_host_uplink
  roles__default_host_uplink --> applications__shell__zsh_host_uplink
  roles__metrics_ingester --> services__monitoring__grafana
  roles__metrics_ingester --> services__monitoring__loki
  roles__metrics_ingester --> services__monitoring__prometheus
  ...
  services__networking__headscale --> services__networking__nginx
  services__web__homepage --> services__security__oauth2_proxy
  unfree_predicate --> unfree_predicate__os
  unfree_predicate --> unfree_predicate__user
  uplink --> hardware__cpu__amd
  uplink --> services__nix__attic
  uplink --> services__web__container_registry
  uplink --> roles__default_host_uplink
  uplink --> services__web__den_docs_mirror
  uplink --> services__networking__haproxy
  uplink --> services__networking__headscale
  uplink --> services__web__homepage
  uplink --> services__bgp__hub
  uplink --> core__network__syncthing__hub
  uplink --> hardware__gpu__intel
  uplink --> services__media__jellyfin
  uplink --> services__security__kanidm
  uplink --> roles__metrics_ingester
  uplink --> core__boot__network_initrd
  uplink --> roles__nix_builder
  uplink --> services__ai__ollama
  uplink --> services__ai__open_webui
  uplink --> virtualization__podman
  uplink --> roles__server
  uplink --> roles__unlock
  uplink --> disk__zfs_disk_single
  virtualization__podman --> virtualization__containers
  end
  ...
  classDef secrets__agenix_host_uplink_c fill:#89b4fa,stroke:#89b4fa,color:#1e1e2e,stroke-width:3px
  ...
  classDef agenix__uplink_c fill:#cba6f7,stroke:#cba6f7,color:#1e1e2e,stroke-width:2px
  ...
  classDef services__nix__attic_c fill:#89b4fa,stroke:#89b4fa,color:#1e1e2e,stroke-width:3px
  ...
  classDef core__systemd__boot_host_uplink_c fill:#cba6f7,stroke:#cba6f7,color:#1e1e2e,stroke-width:3px
  classDef broadcast_hub_peer_c fill:#89b4fa,stroke:#89b4fa,color:#1e1e2e,stroke-width:2px,stroke-dasharray: 8 4
  ...
  classDef core__impermanence__btrfs_host_uplink_c fill:#89b4fa,stroke:#89b4fa,color:#1e1e2e,stroke-width:3px
  ...
  classDef services__web__container_registry_c fill:#cba6f7,stroke:#cba6f7,color:#1e1e2e,stroke-width:3px
  ...
  classDef roles__default_host_uplink_c fill:#89b4fa,stroke:#89b4fa,color:#1e1e2e,stroke-width:3px
  classDef default_host_uplink_c fill:#89b4fa,stroke:#89b4fa,color:#1e1e2e,stroke-width:3px
  classDef den__batteries__define_user_c fill:#89b4fa,stroke:#89b4fa,color:#1e1e2e,stroke-width:3px
  classDef den__batteries__define_user__dvicory_uplink_c fill:#89b4fa,stroke:#89b4fa,color:#1e1e2e,stroke-width:2px
  classDef den__batteries__define_user__pol_uplink_c fill:#89b4fa,stroke:#89b4fa,color:#1e1e2e,stroke-width:2px
  classDef den__batteries__define_user__sini_uplink_c fill:#f2cdcd,stroke:#f2cdcd,color:#1e1e2e,stroke-width:2px
  classDef den__batteries__define_user__theutz_uplink_c fill:#89b4fa,stroke:#89b4fa,color:#1e1e2e,stroke-width:2px
  classDef den__batteries__define_user__vic_uplink_c fill:#f2cdcd,stroke:#f2cdcd,color:#1e1e2e,stroke-width:2px
  classDef services__web__den_docs_mirror_c fill:#89b4fa,stroke:#89b4fa,color:#1e1e2e,stroke-width:3px
  ...
  classDef core__users__deterministic_uids_host_uplink_c fill:#f2cdcd,stroke:#f2cdcd,color:#1e1e2e,stroke-width:3px
  ...
  classDef core__perf__disable_docs_host_uplink_c fill:#89b4fa,stroke:#89b4fa,color:#1e1e2e,stroke-width:3px
  ...
  classDef core__system__facter_host_uplink_c fill:#89b4fa,stroke:#89b4fa,color:#1e1e2e,stroke-width:3px
  ...
  classDef core__system__firmware_host_uplink_c fill:#89b4fa,stroke:#89b4fa,color:#1e1e2e,stroke-width:3px
  classDef services__monitoring__grafana_c fill:#89b4fa,stroke:#89b4fa,color:#1e1e2e,stroke-width:3px
  classDef services__networking__haproxy_c fill:#f2cdcd,stroke:#f2cdcd,color:#1e1e2e,stroke-width:3px
  classDef hardware_c fill:#a6e3a1,stroke:#a6e3a1,color:#1e1e2e,stroke-dasharray: 3 3,stroke-width:1px
  classDef services__networking__headscale_c fill:#89b4fa,stroke:#89b4fa,color:#1e1e2e,stroke-width:3px
  ...
  classDef core__users__home_manager_shared_host_uplink_c fill:#cba6f7,stroke:#cba6f7,color:#1e1e2e,stroke-width:3px
  ...
  classDef services__web__homepage_c fill:#f2cdcd,stroke:#f2cdcd,color:#1e1e2e,stroke-width:3px
  ...
  classDef core__network__hostsfile_host_uplink_c fill:#89b4fa,stroke:#89b4fa,color:#1e1e2e,stroke-width:3px
  classDef services__bgp__hub_c fill:#89b4fa,stroke:#89b4fa,color:#1e1e2e,stroke-width:3px
  classDef core__network__syncthing__hub_c fill:#89b4fa,stroke:#89b4fa,color:#1e1e2e,stroke-width:3px
  ...
  classDef core__localization__i18n_host_uplink_c fill:#cba6f7,stroke:#cba6f7,color:#1e1e2e,stroke-width:3px
  ...
  classDef core__impermanence_host_uplink_c fill:#cba6f7,stroke:#cba6f7,color:#1e1e2e,stroke-width:3px
  ...
  classDef services__media__jellyfin_c fill:#f2cdcd,stroke:#f2cdcd,color:#1e1e2e,stroke-width:3px
  classDef services__security__kanidm_c fill:#89b4fa,stroke:#89b4fa,color:#1e1e2e,stroke-width:3px
  ...
  classDef core__system__linux_kernel_host_uplink_c fill:#cba6f7,stroke:#cba6f7,color:#1e1e2e,stroke-width:3px
  classDef services__monitoring__loki_c fill:#89b4fa,stroke:#89b4fa,color:#1e1e2e,stroke-width:3px
  ...
  classDef core__network__networking_host_uplink_c fill:#89b4fa,stroke:#89b4fa,color:#1e1e2e,stroke-width:3px
  classDef services__networking__nginx_c fill:#cba6f7,stroke:#cba6f7,color:#1e1e2e,stroke-width:3px
  ...
  classDef core__nix_host_uplink_c fill:#cba6f7,stroke:#cba6f7,color:#1e1e2e,stroke-width:3px
  ...
  classDef core__nix__nixpkgs_host_uplink_c fill:#89b4fa,stroke:#89b4fa,color:#1e1e2e,stroke-width:3px
  classDef services__security__oauth2_proxy_c fill:#89b4fa,stroke:#89b4fa,color:#1e1e2e,stroke-width:3px
  classDef services__ai__ollama_c fill:#89b4fa,stroke:#89b4fa,color:#1e1e2e,stroke-width:3px
  classDef services__ai__open_webui_c fill:#89b4fa,stroke:#89b4fa,color:#1e1e2e,stroke-width:3px
  ...
  classDef core__security__openssh_host_uplink_c fill:#cba6f7,stroke:#cba6f7,color:#1e1e2e,stroke-width:3px
  ...
  classDef core__security__opkssh_host_uplink_c fill:#89b4fa,stroke:#89b4fa,color:#1e1e2e,stroke-width:3px
  ...
  classDef os_to_host_host_uplink_c fill:#f2cdcd,stroke:#f2cdcd,color:#1e1e2e,stroke-width:2px,stroke-dasharray: 8 4
  ...
  classDef core__impermanence__persist_collector_host_uplink_c fill:#cba6f7,stroke:#cba6f7,color:#1e1e2e,stroke-width:3px
  ...
  classDef core__impermanence__persist_home_collector_host_uplink_c fill:#f2cdcd,stroke:#f2cdcd,color:#1e1e2e,stroke-width:3px
  ...
  classDef services__monitoring__prometheus_c fill:#f2cdcd,stroke:#f2cdcd,color:#1e1e2e,stroke-width:3px
  ...
  classDef core__security_host_uplink_c fill:#cba6f7,stroke:#cba6f7,color:#1e1e2e,stroke-width:3px
  ...
  classDef core__users__shell_host_uplink_c fill:#cba6f7,stroke:#cba6f7,color:#1e1e2e,stroke-width:3px
  ...
  classDef core__perf__ssd_host_uplink_c fill:#cba6f7,stroke:#cba6f7,color:#1e1e2e,stroke-width:3px
  ...
  classDef core__nix__stateVersion_host_uplink_c fill:#cba6f7,stroke:#cba6f7,color:#1e1e2e,stroke-width:3px
  ...
  classDef core__security__sudo_host_uplink_c fill:#89b4fa,stroke:#89b4fa,color:#1e1e2e,stroke-width:3px
  ...
  classDef core__systemd_host_uplink_c fill:#cba6f7,stroke:#cba6f7,color:#1e1e2e,stroke-width:3px
  ...
  classDef core__network__tailscale_host_uplink_c fill:#f2cdcd,stroke:#f2cdcd,color:#1e1e2e,stroke-width:3px
  ...
  classDef core__localization__time_host_uplink_c fill:#f2cdcd,stroke:#f2cdcd,color:#1e1e2e,stroke-width:3px
  ...
  classDef core__users_host_uplink_c fill:#89b4fa,stroke:#89b4fa,color:#1e1e2e,stroke-width:3px
  ...
  classDef core__utils_host_uplink_c fill:#f2cdcd,stroke:#f2cdcd,color:#1e1e2e,stroke-width:3px
  ...
  classDef core__impermanence__zfs_host_uplink_c fill:#89b4fa,stroke:#89b4fa,color:#1e1e2e,stroke-width:3px
  ...
  classDef core__perf__zram_swap_host_uplink_c fill:#cba6f7,stroke:#cba6f7,color:#1e1e2e,stroke-width:3px
  ...
  classDef applications__shell__zsh_host_uplink_c fill:#cba6f7,stroke:#cba6f7,color:#1e1e2e,stroke-width:3px
