...
| ---------------- | ------------------------------------- | --------------------------------------- |
| Metadata Storage | `charts/`                             | `images/`                               |
| Flake Module     | `helm-charts.nix`                     | `oci-images.nix`                        |
| Updater Tool     | `nixhelm#helmupdater`                 | `oci-image-updater`                     |
| Discovery        | haumea auto-load                      | haumea auto-load                        |
| Flake Output     | `chartsMetadata`, `chartsDerivations` | `imagesMetadata`, `imagesDerivations`   |
| Update Command   | `helmupdater update-all --commit`     | `oci-image-updater update-all --commit` |
