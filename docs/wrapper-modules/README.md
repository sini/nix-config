...
our existing feature system to expose user-level features as standalone
...
- [gitkraken-case-study.md](./gitkraken-case-study.md) — Deep dive into
  wrapping a real HM-dependent feature (gitkraken), obstacles, and three
  approaches
