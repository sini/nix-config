...
|                                           |                                           |                             |                                          | system-access-groups                      |                                           | `environments.<env>.users.<name>.enable` |        |
| Derived                                   |                                           |                             |                                          |                                           |                                           | `hosts.<host>.users.<name>.enable`       | Use    |     |                       |
| `system-access-groups`                    |                                           | instead                     |                                          |                                           |                                           |                                          | Kanidm |     | group defs in service |
