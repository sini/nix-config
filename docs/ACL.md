...
| `users.<name>.system.systemGroups`        | Derived from unix-scoped group            |                                           |                                           |
| membership                                |                                           |                                           |                                           |                                           |                                           |                                           |                                           |                                          |        |     |               |                    | `users.<name>.system.enable` | Derived from |
|                                           |                                           |                                           | system-scoped                             |                                           |                                           | groups                                    |                                           | ∩                                        |        |     |               |                    |                              |              |     | system-access-groups |
|                                           |                                           |                                           |                                           | `environments.<env>.users.<name>.enable`  |                                           |                                           |                                           | Derived                                  |        |     |               |                    |                              |              |
|                                           |                                           |                                           | `hosts.<host>.users.<name>.enable`        | Use                                       |                                           |                                           |                                           |                                          |        |     |
| `system-access-groups`                    |                                           |                                           |                                           | instead                                   |                                           |                                           |                                           |                                          | Kanidm |     | group defs in |                    |
| service                                   |                                           | files                                     | Top-level                                 |                                           |                                           |                                           | `groups`                                  |
