...
- `flake.environments.<name>.kubernetes.loadBalancer`: LoadBalancer configuration
...
- `flake.environments.<name>.kubernetes.services`: Kubernetes service management for this environment.
Use 'enabled' to enable services and 'config' for service-specific options.

- `flake.environments.<name>.kubernetes.services.config`: Service-specific configurations for this environment.
...
- `flake.environments.<name>.networks`: Network definitions for the environment.
Example: `{
