...
- `flake.environments.<name>.kubernetes.services.config.coredns`: [attribute set] Configuration for coredns service
...
- `flake.environments.<name>.networks.<name>.dnsServers`: [list of string] DNS server IPs for this network

- `flake.environments.<name>.networks.<name>.gatewayIp`: [null or string] Gateway IP address for this network

- `flake.environments.<name>.networks.<name>.gatewayIpV6`: [null or string] Gateway IPv6 address for this network
