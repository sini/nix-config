# I don't use this anymore -- used it for about a day :)
# There was a NFS volume mount on 10.10.10.10:/volume2/keys that has the plaintext
# passkeys for my servers volumes so that I didn't have to type passwords...
# This has been replaced by shamir secret sharing with tpm+tang in the default
# network-boot.nix feature
{
  flake.features.nfs-boot.nixos =
    {
      config,
      lib,
      pkgs,
