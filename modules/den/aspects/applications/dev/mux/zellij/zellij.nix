# Based on: https://github.com/hmajid2301/nixicle/blob/a10f7322101d264e9936bb8f5a21dba887338a39/modules/aspects/zellij/default.nix
{
  ...
  den.aspects.applications.dev.mux.zellij = {
    homeManager =
      {
        inputs',
        pkgs,
