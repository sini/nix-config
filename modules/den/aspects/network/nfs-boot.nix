# NFS boot: legacy NFS-based key loading for ZFS unlock.
# Superseded by shamir secret sharing with tpm+tang in network-boot.
{ den, lib, ... }:
{
  den.aspects.nfs-boot = {
    includes = lib.attrValues den.aspects.nfs-boot._;
