  ...
  den.aspects.services.vault = {
    ...
    age-secrets =
      ...
      in
      {
        age.secrets = {
          vault-ca = {
            rekeyFile = env.secretPath + "/vault/vault-ca.age";
            owner = "vault";
            group = "vault";
          };

          "vault-${host.name}" = {
            rekeyFile = env.secretPath + "/vault/vault-${host.name}.age";
            owner = "vault";
            group = "vault";
          };

          "vault-${host.name}-key" = {
            rekeyFile = env.secretPath + "/vault/vault-${host.name}-key.age";
            owner = "vault";
            group = "vault";
            mode = "0400";
          };
          ...
          vault-unseal-key-1 = {
            rekeyFile = env.secretPath + "/vault/vault-unseal-key-1.age";
            owner = "vault";
            group = "vault";
            mode = "0400";
          };
          ...
          vault-unseal-key-2 = {
            rekeyFile = env.secretPath + "/vault/vault-unseal-key-2.age";
            owner = "vault";
            group = "vault";
            mode = "0400";
          };
          ...
          vault-unseal-key-3 = {
            rekeyFile = env.secretPath + "/vault/vault-unseal-key-3.age";
            owner = "vault";
            group = "vault";
            mode = "0400";
          };
