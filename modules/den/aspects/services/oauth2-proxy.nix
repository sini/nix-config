  ...
  den.aspects.services.oauth2-proxy = {
    ...
    nixos =
      ...
      let
        ...
        domain = env.getDomainFor "oauth2-proxy";
      ...
      in
      {
        age.secrets = {
          oauth2-proxy-oidc-secret = {
            rekeyFile = env.secretPath + "/oidc/oauth2-proxy-oidc-client-secret.age";
            generator = {
              tags = [ "oidc" ];
          ...
          oauth2-proxy-cookie-secret = {
            rekeyFile = env.secretPath + "/oauth2-proxy-cookie-secret.age";
