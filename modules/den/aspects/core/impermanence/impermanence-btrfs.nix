      ...
      { host, ... }:
      {
        config = lib.mkIf (host.hasAspect den.aspects.disk.btrfs) {
          boot.initrd.systemd.services = {
            rollback-btrfs-root = lib.mkIf (host.settings.disk.impermanence.wipeRootOnBoot or false) {
            ...
            rollback-btrfs-home = lib.mkIf (host.settings.disk.impermanence.wipeHomeOnBoot or false) {
