# Kexec role: stripped-down NixOS config for network install via kexec.
# Builds a kexec tarball with kernel, initrd, and run script.
{ den, lib, ... }:
{
  den.aspects.kexec = {
    includes = lib.attrValues den.aspects.kexec._;
