{
  flake.features.zen-browser.home =
    { inputs, pkgs, ... }:
    {
      ...
      #       install "https://addons.mozilla.org/firefox/downloads/latest/vimium-ff/latest.xpi";
      ...
      #       install "https://addons.mozilla.org/firefox/downloads/latest/new-tab-override/latest.xpi";
      #     "{7a7a4a92-a2a0-41d1-9fd7-1e92480d612d}" =
      #       install "https://addons.mozilla.org/firefox/downloads/latest/styl-us/latest.xpi";
      #   };
      # };
